class AdminLaptopsController < ApplicationController
 ...
 # before_filter do
  ...
  def create
    ...
    respond_to do |format|
      if @laptop.save
        format.html { redirect_to admin_laptop_url(@laptop.id), notice: 'Laptop was successfully created.' }
  ...
  def laptop_params
    params.require(:laptop).permit(:name, :description, :price, :quantity, :ram, :cpu, :weight, :image)
  end
end
